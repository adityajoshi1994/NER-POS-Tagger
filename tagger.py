...
class Tagger:
    ...
    def evaluate_data(self, sents, labels):
        ...
        with warnings.catch_warnings():
            ...
            confusion_mtrx = metrics.confusion_matrix(all_labels, all_preds)
            #import pickle
            #pickle.dump(confusion_mtrx, open("CRF_POS_FEA", 'wb'), protocol=pickle.HIGHEST_PROTOCOL)
            #plot_confusion_matrix(confusion_mtrx,self.le.classes_,normalize=True)
        return preds
